                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="{{route('blog.index')}}">المدونه</a>
                                </li>
                                <li class="breadcrumb-item active">المعلقه
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع البوستات المعلقه</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <form action="{{route('blog.change',$post -> id)}}"
                                                                      method="post">
                                                                    @csrf
                                                                    @method('post')
                                                                    <button
                                                                        class="btn btn-outline-amber btn-sm  box-shadow-3 mr-1 mb-1">
                                                                        نشر
                                                                    </button>
