                                ...
                                <form action="{{route('blog.update',$post->id)}}" method="post" enctype="multipart/form-data"
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="{{$locale}}[title]" class="form-control" value="{{$post->translate($locale)->title}}">
                                        </div>
                                    @endforeach

                                    @foreach(config('translatable.locales') as $locale)
                                        <div class="form-group">{{ old($locale.'.description')}}
                                            <label>@lang('site.'.$locale.'.description')</label>
                                            <textarea required type="text" name="{{$locale}}[description]" class="form-control ckeditor" >{{$post->translate($locale)->description}}</textarea>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="row">
                                        <div class="card col-md-12" style="margin-top: 70px">
                                            ...
                                            <textarea class="form-control" placeholder="Seo Keywords"
                                                      ...
                                                      name="seo_keyword">{{$post->seo_keyword}}</textarea>
                                                            </div>
                                                        </fieldset>
                                                    </div>
