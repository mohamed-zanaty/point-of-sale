                            ...
                            <div class="card">
                                ...
                                <form action="{{route('product.store')}}" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group custom-file">
                                        ...
                                        <img src="{{ asset('uploads/product.png') }}" style="width: 100px"
                                    ...
                                    <div class="form-group" style="margin-top:50px ">
                                        ...
                                        <input required type="number" step="0.001" name="purchase_price" class="form-control" value="{{ old('purchase_price') }}">
                                    </div>

                                    <div class="form-group">
                                        <label>@lang('site.sale_price')</label>
                                        <input required type="number" step="0.001" name="sale_price" class="form-control" value="{{ old('sale_price') }}">
                                    </div>

                                    <div class="form-group">
                                        <label>@lang('site.stock')</label>
                                        <input required type="number" maxlength="8" name="stock" class="form-control" value="{{ old('stock') }}">
                                    </div>
